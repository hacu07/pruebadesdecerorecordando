...
public class DetallePersonajeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        descripcion = (TextView) vista.findViewById(R.id.desFraDet);
        img = (ImageView) vista.findViewById(R.id.imgFraDet);

        Bundle objetoPersojane = getArguments();

        PersonajeVO personaje = null;

        if (objetoPersojane != null){
            personaje = (PersonajeVO) objetoPersojane.getSerializable("objeto");
            asignarInformacion(personaje);
        }

        return vista;
    }

    public void asignarInformacion(PersonajeVO personaje) {
        descripcion.setText(personaje.getDescripcionDetalle());
        img.setImageResource(personaje.getImgDetalle());
    }
